...
\todo[inline]{Add the reference to the Sections!!!!!!}
\begin{figure}
  \centering
  \begin{tikzpicture}[node distance = 2cm, auto]
  \newcommand{\DEC}[0]{\mathsf{decision}}
  \newcommand{\MEM}[0]{\mathit{Mem.}}
  \newcommand{\EQ}[0]{\mathit{Eq.}}
  \newcommand{\PAC}[0] {PAC(\epsilon, \delta)\text{-correct}}
  ...
  at (3cm,0cm) {\textbf{PAC Automata Learning Algorithm}\\(Section )};
  ...
  \end{tikzpicture}
  \caption{Components of our procedure}
